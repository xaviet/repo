...
comtradeObj = ComtradeRecord('./test3.cfg')

print('analog: %4d' % comtradeObj.A)
print(comtradeObj.Ach_id) # print the ids of the analog channels.
print('digit : %4d' % comtradeObj.D)
print(comtradeObj.Dch_id) # print the ids of the digit channels.
...
AnalogChannelData = comtradeObj.getAnalogChannelData(31)

for el0 in range(1,comtradeObj.A+1):
  AnalogChannelData = comtradeObj.getAnalogChannelData(el0) 
  fh=open('./data/%s.rec'%comtradeObj.Ach_id[el0-1],'w') 
  fh.write('type:A;id:%s;phase:%s;unit:%s;factorA:%f;factorB:%f;samplingRate:%d;samplingNumber:23040;\n'%(comtradeObj.Ach_id[el0-1],comtradeObj.Aph[el0-1],comtradeObj.uu[el0-1],comtradeObj.a[el0-1],comtradeObj.b[el0-1],comtradeObj.samp[0])) 
  for el1 in AnalogChannelData[:23040]:
    fh.write('%d\n'%(int(el1)))
  fh.close()
  
DigitalChannelData = comtradeObj.getDigitalChannelData(0)
DigitalChannelData = comtradeObj.getDigitalChannelData(32)

for el0 in range(1,comtradeObj.D+1):
  DigitalChannelData = comtradeObj.getDigitalChannelData(el0)
  fh=open('./data/%s.rec'%comtradeObj.Dch_id[el0-1],'w')
  fh.write('type:D;id:%s;samplingRate:%d;samplingNumber:23040;\n'%(comtradeObj.Dch_id[el0-1],comtradeObj.samp[0])) 
  for el1 in DigitalChannelData[:23040]:
    fh.write('%d\n'%(int(el1)))
  fh.close()
