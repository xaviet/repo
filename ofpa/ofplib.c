...
int ofpMsgHello(struct ofp_hello* v_pmsg,struct td_linkedlistNode* v_linklistNode)
{
  ...
  t_pOfp=(struct ofp_hello*)malloc(sizeof(struct ofp_hello));memRecoder(t_pOfp,1,0,79);
...
int ofpMsgFeaturesRequest(struct ofp_hello* v_pmsg,struct td_linkedlistNode* v_linklistNode)
{
  ...
  t_pOfp=(struct ofp_switch_features*)malloc(sizeof(struct ofp_switch_features));memRecoder(t_pOfp,1,0,93);
...
int ofpMPPortDesc(struct ofp_multipart_request* v_pmsg,struct td_linkedlistNode* v_linklistNode)
{
  ...
  int t_len=0;
  int t_i=0;
  t_pOfp=(struct ofp_multipart_reply*)malloc(def_stringBuff);memRecoder(t_pOfp,1,0,124);
...
int ofpLldpInquery(struct td_ptnapiPort* v_pPort)
{
  ...
  {
    t_lldpPort=(char*)malloc(16);memRecoder(t_lldpPort,1,0,177);
...
int ofpMsgPacketInLldp(struct ofp_packet_out* v_pmsg,struct td_linkedlistNode* v_linklistNode)
{
  ...
  t_pOfpPacketIn=(struct ofp_packet_in*)malloc(def_stringBuff);memRecoder(t_pOfpPacketIn,1,0,204);
